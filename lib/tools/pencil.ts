...
export const usePencil = (canvasRef: React.RefObject<HTMLCanvasElement>, dialogRef: React.RefObject<HTMLDivElement>, penRef: React.RefObject<HTMLDivElement>): void => {
    let lastPoint = null
